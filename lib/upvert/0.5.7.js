...
var convertSource = function convertSource(old_source) {
  var source = limitFields(['source_id', 'source_type', 'name', 'system', 'additional_properties'], old_source);
  return source;
};
...
var convertComments = function convertComments(old_comments) {
  var comments = limitFields(['comments_period', 'allow_comments', 'display_comments', 'moderation_required'], old_comments);
  return comments;
};
