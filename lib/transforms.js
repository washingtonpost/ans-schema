...
var version_upverter_types = [ "audio", "collection", "content", "gallery", "image", "redirect", "results", "story", "video", "author", "section", "site"];
...
var doSync = function doSync(document, version_to) {
  ...
  if (_.isObject(document) &&
    ...
    if (sub_doc_version.lt(version_to) && version_upverter_types.includes(document.type)) {
