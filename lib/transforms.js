...
var version_upverter_types = [ "audio", "colletion", "content", "gallery", "image", "redirect", "results", "story", "video", "author", "section", "site"];
...
var doSync = function doSync(document, version_to) {
  ...
  if (_.isObject(document) &&
      ...
      !_.isNil(document.type) && version_upverter_types.includes(document.type)) {
