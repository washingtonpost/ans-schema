...
## The current production version of ANS is 0.10.0
## The current development version of ANS is 0.10.1
...
1. [An Example Story](tests/fixtures/schema/0.10.0/story-fixture-references.json)
2. [An Example Video](tests/fixtures/schema/0.10.0/video-fixture-nationals.json)
3. [An Example Image](tests/fixtures/schema/0.10.0/image-fixture-good.json)
...
```
npm install
npm run-script ans -- --ansdata='{"type":"story", "version":"0.8.1"}' --version=0.10.0 validate

[
  {
    "keyword": "enum",
    "dataPath": ".version",
    "schemaPath": "https://raw.githubusercontent.com/washingtonpost/ans-schema/master/src/main/resources/schema/ans/0.10.0/traits/trait_version.json/enum",
    "params": {},
...
```
npm run-script ans -- --ansfile=test.json --version=0.10.0 validate
...
ans.getValidatorForVersion('0.10.0', function(err, validator) {
...
```
npm run-script ans -- --ansdata='{"type":"story", "version":"0.10.0", "content_elements":[{"type":"gallery", "version":"0.8.1", "content_elements":[ {"type":"image", "version":"0.8.1", "url":"http://foo.com/img.jpg"}]}]}' sync
