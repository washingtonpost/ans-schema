...
public class Story extends Content {
    ...
    /**
     * @return A list of IDs referencing other content items this story is related to.
     */
    ...
    /**
     * @param relatedContent A list of IDs referencing other content items this story is related to.
     */
    ...
    /**
     * @return An ordered list of the elements that make up the content (i.e. "the meat of the story") for this Object
     */
    ...
    /**
     * @param contentElements An ordered list of the elements that make up the content (i.e. "the meat of the story") for this
     */
